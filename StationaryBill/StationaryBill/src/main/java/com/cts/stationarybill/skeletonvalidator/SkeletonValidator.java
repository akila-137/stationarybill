...
public class SkeletonValidator {
	public SkeletonValidator() {
		validateClassName("com.cts.stationarybill.service.CartService");
		validateClassName("com.cts.stationarybill.vo.Item");
		validateClassName("com.cts.stationarybill.vo.MyCart");
		validateClassName("com.cts.stationarybill.bo.CartBO");
		
		validateMethodSignature(
				"calculateOrderTotalBill:double,validateCostperQuantity:boolean",
				"com.cts.stationarybill.service.CartService");
		validateMethodSignature(
				"calculateBillAfterDiscount:double,countNoteBook:int,countPen:int",
				"com.cts.stationarybill.bo.CartBO");
